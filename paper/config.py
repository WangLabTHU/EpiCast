...
# Blue, yellow, green, red, purple in the order above. An earlier version put orange
# between red and yellow, and at scatter-point size the HepG2 orange and the SK-N-SH
# yellow were not tellable apart, so orange is gone. The purple is
...
# fig5 only reads the display names: its boxes are all white and colour there means
# cell type.
