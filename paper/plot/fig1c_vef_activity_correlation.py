...
The box is the conventional one, whiskers and caps included. Read it as decoration rather
than as statistics: at n=5 the quartiles land exactly on the second and fourth point and the
1.5 IQR rule calls a cell type an outlier whenever the outer gap exceeds the middle spread,
which happens in 7 of these 16 positions. Fliers are switched off, so such a point is still
drawn, just as one of the five coloured dots.
