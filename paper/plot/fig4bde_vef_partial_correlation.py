...
as in fig1C. The box is the conventional one, whiskers and caps included; at n=5 read it as
decoration rather than as statistics, since the quartiles land on the second and fourth point
and the 1.5 IQR rule calls a cell type an outlier in 22 of these 48 positions. Fliers are
off, so such a point is still drawn, just as one of the five coloured dots.
